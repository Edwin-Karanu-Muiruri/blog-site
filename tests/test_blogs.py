...
class TestBlog(unittest.TestCase):
    ...
    def setUp(self):
        ...
        """
        self.new_user = User(username = "Master")
        self.new_blog = Blog(title = "blogs", user = self.new_user)
    ...
    def test_init(self):
        ...
        self.assertEquals(self.new_blog.title, "blogs")
